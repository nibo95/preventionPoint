class ExchangesController < ApplicationController
  ...
  private
    ...
    def exchange_params
      params.require(:exchange).permit(:ultrafines, :halfs, :pogos, :blues, :one_qt, :two_qt, :three_gal, :alcohol_whipes, :cookers, :cottons, :ties, :bleach, :condoms, :ascorbic_acid, :pieces_of_lit, :narcan, :secondary_exchange)
    end
end
